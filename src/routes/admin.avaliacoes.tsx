                ...
                <div className="px-5 pb-6 pt-2 bg-muted/10 space-y-5">
                  ...
                  <div className="border-2 border-primary bg-primary/5 px-4 py-3">
                    <div className="flex items-center justify-between gap-3 flex-wrap">
                      ...
                      {r.discount_used ? (
                        <span className="text-[10px] uppercase tracking-wider px-3 py-2 border border-border bg-muted text-muted-foreground cursor-not-allowed">
                          Cupom utilizado
                        </span>
                      ) : (
                        <button
                          ...
                          className="text-[10px] uppercase tracking-wider px-3 py-2 border border-primary bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
                        >
